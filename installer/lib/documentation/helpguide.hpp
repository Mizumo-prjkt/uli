...
inline void print_help_guide() {
    std::cout << "Universal Linux Installer (ULI) - Help Guide\n"
              << "============================================\n"
              << "Usage:\n"
              << "  uli_installer [OPTIONS] [COMMANDS]\n\n"
              << "Description:\n"
              << "  ULI is a unified tool designed to deploy and standardise\n"
              << "  Linux installations across multiple distributions (Debian, Arch, Alpine).\n"
              << "  It reads a standard YAML deployment profile and uses translation\n"
              << "  dictionaries to configure the system with native package managers.\n\n"
              << "Commands:\n"
              << "  install       Starts the installation process given a profile.\n"
              << "  translate     Tests the package translation against a dictionary.\n\n"
              << "Options:\n"
              << "  --help, -h    Displays this standard help guide.\n"
              << "  --extra-help  Displays extended documentation for profiles and translation.\n"
              << "  --profile     Specify the path to the YAML deployment profile.\n"
              << "  --lintcheck   Validates the YAML profile for syntax and logic errors.\n"
              << "  --disable-builtin-dict Disables the onboard instruction fallback (embedded trans.yaml).\n"
              << "  --dict        Specify the path to the YAML package translation dictionary.\n"
              ...
              << "                arch, debian, debian:12, debian:13, ubuntu, alpine\n"
