#ifndef ULI_TIMEDATE_TZ_DICT_HPP
#define ULI_TIMEDATE_TZ_DICT_HPP
...
class TzDict {
public:
    static std::vector<std::pair<std::string, std::string>> get_fuzzy_dictionary() {
        return {
...
#endif // ULI_TIMEDATE_TZ_DICT_HPP
